 ...
 * Use the {@link com.tqrapps.friscocenter.fragments.FacebookYouth#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FacebookYouth extends Fragment  {
    ...
    WebView facebookWeb;
    String WEB_URL = "http://www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2FFriscoICFYouth&width=400px&height=700&colorscheme=light&show_faces=false&header=false&stream=true&show_border=false&appId=744004655693608";
    ProgressDialog progressDialog;
    SwipeRefreshLayout swipeView;
    private ViewTreeObserver.OnScrollChangedListener mOnScrollChangedListener;


    public FacebookYouth() {

    }

    // TODO: Rename and change types and number of parameters
    public static FacebookYouth newInstance(String param1, String param2) {
        FacebookYouth fragment = new FacebookYouth();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.facebook_youth, container, false);
        facebookWeb = (WebView) view.findViewById(R.id.facebookWebYouth);
        ...
        swipeView = (SwipeRefreshLayout) view.findViewById(R.id.swipeYouth);
