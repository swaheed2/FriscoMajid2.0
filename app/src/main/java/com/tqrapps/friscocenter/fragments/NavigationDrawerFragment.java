...
import com.tqrapps.friscocenter.activities.AboutActivity;
import com.tqrapps.friscocenter.activities.ContactActivity;
import com.tqrapps.friscocenter.activities.ImamActivity;
import com.tqrapps.friscocenter.activities.SuggestionsActivity;
import com.tqrapps.friscocenter.adapters.VivzAdapter;
import com.tqrapps.friscocenter.R;
import com.tqrapps.friscocenter.pojo.Information;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public static List<Information> getData() {
        ...
        int[] icons = {R.drawable.imam_icon, R.drawable.contact_icon, R.drawable.about_icon, R.drawable.ic_action_calendar};
        String[] titles = {"Imam's Corner", "Contact", "About","Suggestions"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView,new ClickListener() {
            ...
            public void onClick(View view, int position) {
                if(position==0){
                    Intent intent = new Intent(getActivity(), ImamActivity.class);
